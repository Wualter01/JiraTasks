...
public class SumOfNumbers {
    public static void main(String[] args) {
        ...
        to store our Y and N. then we need to store our two numbers in a container in this case int so that the
        ...
        //while will server as our second phase. in while we can ask user if he'd like to continue and run
        ...
        if (choice== 'n'||choice=='N'){
            ...
            System.out.println("wrong character entered. please choose either y/n");
        }
